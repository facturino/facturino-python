...
import respx
import facturino
from facturino._types import PaRejectionCategory, PaRejectionSource, InvoiceEinvoicing, PaymentCollectionStatus, WebhookEvent
...
def test_invoice_resource_preserves_rejection_and_archive():
    ...
    assert result["einvoicing"]["previousSubmissions"][0]["rejectionNote"] == "L’adresse de réception doit être confirmée."
